...
import { upsertAnchorCallbackEvent } from "../../../lib/repositories/anchor-events.js";
...
export default async function handler(req, res) {
    ...
    const callbackToken = pickString(payload, ["callbackToken", "callback_token"]) ||
    ...
    const sourceAnchor = pickString(payload, ["sourceAnchor", "source_anchor", "anchor", "home_domain"]) ||

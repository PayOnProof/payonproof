...
Verify on Stellar: https://stellar.expert/explorer/public/tx/${proof.stellarTxHash}
    `.trim();
      ...
      <div className="flex flex-col gap-6 animate-fade-in-up">
        <Card className="rounded-2xl border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Open both anchor links, complete deposit/withdrawal, then paste the resulting
            Stellar hash to verify on-chain.
          </p>
          {polling && (
            <p className="mt-2 inline-flex items-center gap-2 text-xs text-muted-foreground">
              <Loader2 className="h-3 w-3 animate-spin" />
              Auto-checking anchor status...
            </p>
          )}
          {autoStatus && (
            <p className="mt-1 text-xs text-muted-foreground">{autoStatus}</p>
          )}
          ...
          {verifyError && (
            <p className="mt-3 text-xs text-destructive">{verifyError}</p>
          )}

          <div className="mt-4 flex gap-2">
            <Button onClick={handleVerify} disabled={verifying} className="rounded-xl">
              {verifying ? (
                <>
        ...
        <div className="p-4 sm:p-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2">
              ...
              <a
                href={`https://stellar.expert/explorer/public/tx/${proof.stellarTxHash}`}
                target="_blank"
                rel="noopener noreferrer"
                className={cn(
